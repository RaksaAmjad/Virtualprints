...
<div class="col-12">
	<div class="card">
		<div class="card-body">
			...
			<br>
			<div>
				<div class="laporan-header"><h3>VirtualPrints</h3></div>
					...
					if ($tipe == 'print'):
						...
						foreach ($print as $key => $value):
							...
							<tr>
								...
								<td><?= ucfirst($value['print_bahan']) ?></td>
								<td><?= $value['print_jumlah'] ?> rim</td>
								<td>Rp. <?= nominal($value['print_total']) ?></td>
							</tr>
							<?php
							$total = $total + $value['print_total'];
							$no++;
						endforeach; ?>
						</tbody>
						<tfoot>
				...
				<div class="row">
					...
					<div class="col-6 text-center">
						<p>Surabaya, <?= date_indo(date('Y-m-d')) ?></p>
						<p>Manajer</p>
						<br>
						<br>
						<br>
						<p><b><u>VirtualPrints</u></b></p>
					</div>
				</div>
			</div>
		</div>
