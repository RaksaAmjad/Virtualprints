...
<body>
	<div class="container-scroller">
		<div class="container-fluid page-body-wrapper">
			<div class="row">
				<div class="content-wrapper full-page-wrapper d-flex align-items-center auth cadetblue-full-bg">
					<div class="row w-100">
						<div class="col-lg-4 mx-auto">
							...
							<div class="auth-form-dark text-left p-5">
								<h2>Login Admin</h2>
								<h4 class="font-weight-light">Selamat Datang di Login Admin</h4>
								...
								<div class="mt-2">
									<button class="btn btn-warning" onclick="location.href='http://localhost/virtualprints'">Home</button>
								</div>
								<?= form_close() ?>
								<br>
							</div>
